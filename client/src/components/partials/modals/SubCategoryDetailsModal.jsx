...
const SubCategoryDetailsModal = ({ subCategoryDetails, onClose }) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white rounded-xl shadow-lg z-50 max-w-md w-full mx-4">
                <div className="text-lg font-semibold bg-blue-500 text-white py-2">
                    <span className='px-5'>Sub Category Details</span>
                </div>
                <div className='px-5 py-3'>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        ...
                        <p className="w-4/6">{subCategoryDetails.id}</p>
                    </div>
                    <div className="flex w-full mb-2 border hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        ...
                        <p className="w-4/6">{subCategoryDetails.name}</p>
                    </div>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Slug</p>
                        <p className="w-4/6">{subCategoryDetails.slug}</p>
                    </div>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Category</p>
                        <p className="w-4/6">{subCategoryDetails.category_name}</p>
                    </div>
                    <div className="flex w-full mb-2 border hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Description</p>
                        <p className="w-4/6">{subCategoryDetails.description}</p>
                    </div>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Serial</p>
                        <p className="w-4/6">{subCategoryDetails.serial}</p>
                    </div>
                    <div className="flex w-full mb-2 border hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Status</p>
                        <p className={subCategoryDetails.status === 'Active' ? 'text-green-500' : 'text-red-500'}>
                            {subCategoryDetails.status}
                        </p>
                    </div>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Created By</p>
                        <p className="w-4/6">{subCategoryDetails.created_by}</p>
                    </div>
                    <div className="flex w-full mb-2 border hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Created At</p>
                        <p className="w-4/6">{subCategoryDetails.created_at}</p>
                    </div>
                    <div className="flex w-full mb-2 border bg-slate-100 hover:bg-blue-500 hover:text-white hover:scale-125 hover:rounded-lg">
                        <p className="font-semibold text-sm w-2/6">Updated At</p>
                        <p className="w-4/6">{subCategoryDetails.updated_at}</p>
                    </div>
                </div>
            </div>
        </div>

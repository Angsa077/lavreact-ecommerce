...
const AddProduct = () => {
    ...
    const handleSpecificationFieldsRemove = (id) => {
        setSpecificationField((prevSpecFields) => prevSpecFields.filter(fieldId => fieldId !== id));
        const updatedSpecInput = { ...specificationInput };
        delete updatedSpecInput[id];
        setSpecificationInput(updatedSpecInput);
    };

    const handleSpecificationFieldAdd = () => {
        const newFieldId = specificationFieldId + 1;
        setSpecificationField((prevSpecFields) => [...prevSpecFields, newFieldId]);
        setSpecificationFieldId(newFieldId);
    };
            ...
            <div className='border border-slate-100 shadow-md mt-3'>
                ...
                {isOpenModal && (
                    <div>
                        ...
                        <div className='border border-slate-100 shadow-md my-5 mx-8'>
                            <div className='flex justify-between border py-1 bg-gray-50'>
                                <h2 className='ml-3 text-lg font-semibold text-blue-500 py-2'>
                                    Product Specifications
                                </h2>
                            </div>

                            {specificationField.map((id, ind) => (
                                <div key={ind} className='px-8 py-4'>
                                    <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4'>
                                        <div className="">
                                            <label htmlFor='name_specification' className="block text-gray-700">Specification Name</label>
                                            <input
                                                type="text"
                                                id='name_specification'
                                                value={specificationInput[id]?.name_specification ?? ''}
                                        ...
                                        <div className="">
                                            <label htmlFor='value_specification' className="block text-gray-700">
                                                Specification Value
                                            </label>
                                            <input
                                                type="text"
                                                id='value_specification'
                                                value={specificationInput[id]?.value_specification ?? ''}
                                        ...
                                        <div className="flex items-center">
                                            {specificationField.length - 1 == ind ?
                                                <button
                                                    className='bg-red-500 text-white rounded-lg p-2'
                                                    onClick={() => handleSpecificationFieldsRemove(id)}
                                                >
                                                    Remove
                                                </button> : null
                                            }
                        ...
                        <div className='border border-slate-100 shadow-md my-5 mx-8'>
                            <div className='flex justify-between border py-1 bg-gray-50'>
                                <h2 className='ml-3 text-lg font-semibold text-blue-500 py-2'>Description</h2>
                            </div>
                            <div className='px-8 py-4 grid grid-cols-1'>
                                <textarea
                                    type="text"
                        ...
                        <div className='text-center my-5'>
                            <button
                                className='bg-blue-500 text-white px-16 py-1 rounded-full shadow-md hover:scale-105'

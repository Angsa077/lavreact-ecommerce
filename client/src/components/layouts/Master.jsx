                ...
                <div className="h-full px-3 pb-4 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        ...
                        {[
                            ...
                            {
                                label: 'Products',
                                icons: <PiShoppingBagOpenDuotone />,
                                arrowDropdownRight: <IoMdArrowDropright />,
                                arrowDropdownDown: <IoMdArrowDropdown />,
                                submenu: [
                                    { label: 'Product List', to: '/product', icons: <FaCircle /> },
                                    { label: 'Add Product', to: '/product/create', icons: <FaCircle /> },
                                    { label: 'Trash', to: '/product/trash', icons: <FaCircle /> },
                                ],
                            },
                            {
                                label: 'Category',
                            ...
                            { label: 'Attributes', to: '/attribute', icons: <HiOutlineNewspaper /> },
                        ].map((item, index) => (
                            <li
                                key={index}
